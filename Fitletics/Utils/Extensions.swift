...
extension UILabel {
    func attributedTitle(firstPart: String, secondPart: String){
        let boldatts: [NSAttributedString.Key: Any] = [.foregroundColor: UIColor.red, .font: UIFont.boldSystemFont(ofSize: 12)]
        let attributedTitle = NSMutableAttributedString(string: "\(firstPart) ", attributes: boldatts)
        
        let atts: [NSAttributedString.Key: Any] = [.foregroundColor: UIColor.white, .font: UIFont.systemFont(ofSize: 12)]
